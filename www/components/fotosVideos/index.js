...
function uploadVideo(mediaFile) {
    try {
        ...
        var fileVideo = document.getElementById('numOT_2').value + "_Despacho_" + JSON.parse(localStorage.getItem("fotosviedeosALI")).punto_venta + "_" +
...
function uploadVideo_2(mediaFile) {
    try {
        ...
        try {
            ...
            localStorage.getItem("ls_ussucursal").toLocaleString() + "_" +
            localStorage.getItem("ls_usagencia").toLocaleString();
            var nombreArchivoEV = document.getElementById("numOT_2").value + "_Despacho_" + JSON.parse(localStorage.getItem("fotosviedeosALI")).punto_venta  
        ...
        setTimeout(function () {
            ...
            ft.upload(mediaFile, UrlSube,
                   ...
                   function (error) {
                       endo.ui.progress($("#fotoVideoScreen"), false);
                       window.myalert("<center><i class=\"fa fa-exclamation-triangle\"></i> ERROR</center>", inspeccionar(error));
                   },
           options);
...
function parametrosOTCompleto() {
    try {
        var accResp = "";
        var Url = localStorage.getItem("ls_url2").toLocaleString() + "/Services/TG/Parametros.svc/ParametroEmpGet/6,;TG;APP_ALISTAMIENTO_PDI;;PATH";
        var respPar;
