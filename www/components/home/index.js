...
app.home = kendo.observable({
    onShow: function () {
        ...
        llamarNuevoestiloIcon("icnMenuAli");
    },
    afterShow: function() {}
});
...
//alert(Url);
   ...
   // Crea el combo de Agencias con la data anterior 
    if (accResp.length > 0) {
        ...
        cboAgenciaHTML += "</select> </p><button id='btnAceptarMenuAli0' class='w3-button w3-block w3-section w3-ripple w3-padding' onclick='agenciaActiva()'>ASIGNAR</button>";
        document.getElementById("cboAgenciaUsu").innerHTML = cboAgenciaHTML;
        llamarNuevoestilo("btnAceptarMenuAli");
